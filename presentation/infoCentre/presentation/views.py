...
template_name=""
views={
"END":"http://localhost:5601/app/kibana#/visualize/edit/e2d1bd90-a10b-11ea-9ef1-e1012968d7dc?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-2y,to:now))&_a=(filters:!(),linked:!f,query:(language:kuery,query:''),uiState:(),vis:(aggs:!(),params:(expression:'.es(index%3Ddossier1,timefield%3D!'journee!',metric%3Dsum:dossier_en_cours).label(%22nombre%20total%20de%20dossier%20en%20cours%20%22),%0D%0A.es(index%3Ddossier1,timefield%3D!'journee!',metric%3Dsum:nombre_de_ci).label(%22nombre%20de%20dossier%20en%20compl%C3%A9ment%20d!'information%20%22).color(!'yellow!'),%0D%0A.es(index%3Ddossier1,timefield%3D!'journee!',metric%3Dsum:nombre_de_signature).label(%22nombre%20de%20dossier%20sign%C3%A9s%20%22).color(!'blue!'),%0D%0A.es(index%3Ddossier1,timefield%3D!'journee!',metric%3Dsum:nombre_de_rejection).label(%22nombre%20de%20dossier%20rejet%C3%A9%22).color(!'red!')%0D%0A',interval:'1w'),title:'Dossier%20evolution%20du%20nombre%20de%20dossier%20en%20fonctoin%20de%20son%20etat(CI,initi%C3%A9,rejet%C3%A9,sign%C3%A9))',type:timelion))",
...
def getVue(request,id):
    ...
    if request.user.is_authenticated:
        return render(request,'visualisations/dashboard.html',{'link':a})
